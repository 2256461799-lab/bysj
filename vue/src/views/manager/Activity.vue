  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column label="查看活动详情" width="120" align="center">
          <template v-slot="scope">
            <el-button style="width: 100px" @click="preview(scope.row.content)">查看内容</el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog title="活动" :visible.sync="fromVisible" width="60%" :close-on-click-modal="false" destroy-on-close>
